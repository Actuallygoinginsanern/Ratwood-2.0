...
/datum/species/abductor
	...
	offset_features = list(
		...
		OFFSET_CLOAK = list(0,0), OFFSET_FACEMASK = list(0,1), OFFSET_HEAD = list(0,0), \
		...
		OFFSET_SHIRT = list(0,1), OFFSET_ARMOR = list(0,1), OFFSET_HANDS = list(0,0), OFFSET_UNDIES = list(0,0), \
